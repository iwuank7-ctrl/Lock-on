...
btn.InputBegan:Connect(function(input, gameProcessed)
	if input.UserInputType == Enum.UserInputType.MouseButton1 and not clicando then
		clicando = true
		posInicial = btn.AbsolutePosition
	end
end)
...
RunService.RenderStepped:Connect(function()
	if clicando then
		btn.Position = UDim2.new(0, mouse.X - 50, 0, mouse.Y - 50)
	end
end)
...
btn.MouseButton1Down:Connect(function()
	wait(0.1) -- Pequena pausa para não confundir com drag
